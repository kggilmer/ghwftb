    ...
    tasks.withType<org.jetbrains.dokka.gradle.DokkaTaskPartial>().configureEach {
        ...
        dokkaSourceSets.configureEach {
            externalDocumentationLink {
                packageListUrl.set(URL("https://raw.githubusercontent.com/kggilmer/smithy-kotlin/api-docs/package-list"))
                url.set(URL("https://kggilmer.github.io/smithy-kotlin/runtime/"))
            }
        }
    }
}
